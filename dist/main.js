    ...
    function main() { 
        jQuery(document).ready(function($) { 
            ...
            var css_link = $("<link>", { 
                rel: "stylesheet", 
                type: "text/css", 
                href: "https://cdn.jsdelivr.net/gh/np-ally/tadpoll@0.0.3/dist/main_style.css" 
            });
            css_link.appendTo('head');  
            
            var id = getParams("np-ally/tadpoll@0.0.3/dist/main.js");
            ...
            //console.log(window.location.hostname);
                if (custParams === undefined) {
                    ...
                    loadScript("https://cdn.jsdelivr.net/gh/np-ally/tadpoll@0.0.3/dist/youtube_demo.js" + video_query, "text/javascript")
                    .then(script => {
                        if (custParams.fields.form === "default"){
                            loadScript("https://cdn.jsdelivr.net/gh/np-ally/tadpoll@0.0.3/dist/form.js", "text/javascript");
                        }
