(function () {
    ...
    function loadform() {
        jQuery(document).ready(function($) {
            ...
            $( ".labeldata1" ).append( "<p style='font-family:Roboto; font-size:15px; color:000000; text-align:left; padding-left:22%;'>Has ROI from video been a challenge?</p>" );
            ...
            $( ".labeldata2" ).append( "<p style='font-family:Roboto; font-size:15px; color:000000; text-align:left; padding-left:22%;'> How do you measure success?</p>" );
